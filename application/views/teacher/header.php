				...
				<div class="row">
					...
					<div class="col-md-2 left-sidebar">
						...
						<nav class="main-nav">
							<ul class="main-menu">
								<li class="active">
								<?php echo anchor('teacher', 'HOME', 'class="js-sub-menu-toggle"><i class="fa fa-home fa-fw"></i><span class="text"'); ?>
									<!-- <a href="#" class="js-sub-menu-toggle"><i class="fa fa-home fa-fw"></i><span class="text">HOME</span></a> -->
								</li>
								<li >
									<?php echo anchor('teacher/loadWork', 'ภาระงาน', 'class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text"'); ?>
									<!-- <a href="#" class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text">ภาระงาน</span></a> -->
								</li>
								<li >
									<?php echo anchor('teacher/searchStudent', 'ค้นหานักศึกษา', 'class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text"'); ?>
									<!-- <a href="#" class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text">ค้นหานักศึกษา</span></a> -->
								</li>
								<li >
									<?php echo anchor('teacher/searchPaper', 'ค้นหาภาคนิพนธ์', 'class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text"'); ?>
									<!-- <a href="#" class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text">ค้นหาภาคนิพนธ์</span></a> -->
								</li>
								<li >
									<?php echo anchor('#', 'ค้นหางานวิจัย', 'class="js-sub-menu-toggle"><i class="fa fa-th-list fa-fw"></i><span class="text"'); ?>
